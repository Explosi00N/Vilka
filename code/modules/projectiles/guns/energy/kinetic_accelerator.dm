...
/obj/item/borg/upgrade/modkit/damage
	...
	desc = "Стандартный модуль. Повышает урон выстрелов кинетического акселератора."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/resonator_blasts
	...
	desc = "Стандартный модуль. Модифицирует выстрелы кинетического акселератора, позволяя им оставлять за собой и взрывать поля резонатора."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/bounty
	name = "death syphon"
	desc = "Стандартный модуль. При установке, убийство или помощь в убийстве существа навсегда увеличивает урон, наносимый этому типу фауны."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/chassis_mod
	name = "super chassis"
	desc = "Бесплатный модуль. Покрывает ваш кинетический акселератор блестящим, желтым корпусом. Все плюсы улучшенного КА, без улучшенного КА."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/chassis_mod/orange
	name = "hyper chassis"
	desc = "Бесплатный модуль. Покрывает ваш КА стильным оранжевым корпусом. Всё веселье устаревших технологий, без устаревших технологий."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/tracer
	...
	desc = "Бесплатный модуль. Перекрашивает выстрелы кинетического акселератора в белый цвет."
	ru_names = list(
...
/obj/item/borg/upgrade/modkit/tracer/adjustable
	...
	desc = "Бесплатный модуль. Перекрашивает выстрелы кинетического акселератора. Используйте в руке чтобы выбрать цвет."
	ru_names = list(
